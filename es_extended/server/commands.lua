...
TriggerEvent('es:addGroupCommand', 'setfaction', 'superadmin', function(source, args, user)
  local xPlayer = ESX.GetPlayerFromId(args[2])
  xPlayer.setFaction(args[3], tonumber(args[4]))
end, function(source, args, user)
  TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficient Permissions.")
end, {help = 'setfaction', params = {{name = "id", help = 'PlayerID'}, {name = "faction", help = 'faction'}, {name = "grade_id", help = 'Grade'}}})
...
TriggerEvent('es:addGroupCommand', 'givemoney', 'superadmin', function(source, args, user)
